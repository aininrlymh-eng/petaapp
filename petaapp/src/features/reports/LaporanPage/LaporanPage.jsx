  ...
  const handleImageChange = (e) => {
    ...
    if (files.length > 0) {
      ...
      if (oversizedFiles.length > 0) {
        setError('Batas ukuran maksimum foto adalah 5 Megabyte (MB). Silakan unggah foto dengan ukuran yang lebih kecil.');
        return;
      }

      setError(''); // Hapus pesan kesalahan sebelumnya jika berhasil
          ...
          <form className="laporan-form" onSubmit={handleSubmit}>
            ...
            <div className="multiple-upload-section">
              <label className="upload-label">
                Unggah Foto Bukti 
                <span style={{ textTransform: 'none', fontSize: '12px', color: '#64748b', fontWeight: 'normal', marginLeft: '8px' }}>
