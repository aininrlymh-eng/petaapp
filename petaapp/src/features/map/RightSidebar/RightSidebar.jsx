  ...
  return (
    <aside className="right-sidebar">
      <div className="rs-header">
        <h2 style={{ fontSize: '18px', fontWeight: 700, color: '#0f172a', margin: 0, textAlign: 'left' }}>
          {activeDataType === 'sungai' ? 'Direktori Sungai' : 'Desa Adiwarno, Kecamatan Selomerto, Kabupaten Wonosobo, Provinsi Jawa Tengah'}
        </h2>
      </div>
      ...
      <div className="rs-scrollable-content">
        ...
        {activeDataType === 'sungai' && (
          <>
            <div className="village-content" style={{ marginBottom: '10px' }}>
              <p className="village-desc" style={{ textAlign: 'justify', color: '#475569', fontSize: '13px', lineHeight: '1.6' }}>
                Sungai dan sistem jaringan air merupakan elemen vital pendukung utama pertanian di Desa Adiwarno. Aliran air dari jaringan sungai di wilayah Selomerto dimanfaatkan oleh para petani untuk menyuplai air ke saluran irigasi teknis sawah-sawah warga. Dengan manajemen pengairan yang baik dan terintegrasi, pasokan air tetap terjaga sepanjang tahun untuk mencegah kekeringan dan mengoptimalkan hasil panen raya desa.
              </p>

              <div className="village-stats-simple" style={{ marginTop: '20px', paddingTop: '16px', borderTop: '1px solid #f1f5f9', marginBottom: '10px' }}>
                <div className="v-stat">
                  <span className="v-label" style={{ fontSize: '11px', fontWeight: 700, color: '#94a3b8', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Total Panjang Aliran Sungai</span>
                  <span className="v-value" style={{ fontSize: '20px', fontWeight: 700, color: '#0ea5e9', marginTop: '4px', display: 'block' }}>
                    {(data.reduce((acc, curr) => acc + parseFloat(curr.length || 0), 0)).toFixed(2)} KM
                  </span>
                </div>
              </div>
            </div>
